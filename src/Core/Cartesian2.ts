...
export default class Cartesian2 extends Vector2 {
     ...
     */
    static equalsEpsilon(left?: Cartesian2, right?: Cartesian2, relativeEpsilon = 0.0, absoluteEpsilon?: number): boolean {
        return left === right || (defined(left) && defined(right) && CesiumMath.equalsEpsilon((left as Cartesian2).x, (right as Cartesian2).x, relativeEpsilon, absoluteEpsilon) && CesiumMath.equalsEpsilon((left as Cartesian2).y, (right as Cartesian2).y, relativeEpsilon, absoluteEpsilon));
    }
    ...
    static equals(left?: Cartesian2, right?: Cartesian2): boolean {
        return left === right || (defined(left) && defined(right) && (left as Cartesian2).x === (right as Cartesian2).x && (left as Cartesian2).y === (right as Cartesian2).y);
    }
