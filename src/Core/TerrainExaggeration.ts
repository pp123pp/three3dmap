...
const TerrainExaggeration = {
     ...
     */
    getPosition: function (position: Cartesian3, ellipsoid: Ellipsoid, terrainExaggeration: number, terrainExaggerationRelativeHeight: number, result: Cartesian3): Cartesian3 {
        const cartographic = ellipsoid.cartesianToCartographic(position, scratchCartographic) as Cartographic;
        const newHeight = TerrainExaggeration.getHeight(cartographic.height, terrainExaggeration, terrainExaggerationRelativeHeight);
