...
export default class Cartesian3 extends Vector3 {
    ...
    static equalsEpsilon(left?: Cartesian3, right?: Cartesian3, relativeEpsilon?: number, absoluteEpsilon?: number): boolean {
        return left === right || (defined(left) && defined(right) && CesiumMath.equalsEpsilon((left as Cartesian3).x, (right as Cartesian3).x, relativeEpsilon, absoluteEpsilon) && CesiumMath.equalsEpsilon((left as Cartesian3).y, (right as Cartesian3).y, relativeEpsilon, absoluteEpsilon) && CesiumMath.equalsEpsilon((left as Cartesian3).z, (right as Cartesian3).z, relativeEpsilon, absoluteEpsilon));
    }
    ...
    static equals(left?: Cartesian3, right?: Cartesian3): boolean {
        return left === right || (defined(left) && defined(right) && (left as Cartesian3).x === (right as Cartesian3).x && (left as Cartesian3).y === (right as Cartesian3).y && (left as Cartesian3).z === (right as Cartesian3).z);
    }
