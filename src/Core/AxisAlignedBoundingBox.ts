...
class AxisAlignedBoundingBox {
    ...
    maximum: Cartesian3;
    center: Cartesian3;
    constructor(minimum = Cartesian3.ZERO, maximum = Cartesian3.ZERO, center?: Cartesian3) {
        /**
        ...
        if (!defined(center)) {
            ...
            center = Cartesian3.clone(center as Cartesian3);
        }
         ...
         * @type {Cartesian3}
         */
        this.center = center as Cartesian3;
    }
     ...
     */
    static clone(box: AxisAlignedBoundingBox, result = new AxisAlignedBoundingBox()): AxisAlignedBoundingBox | undefined {
        if (!defined(box)) {
            return undefined;
        }
    ...
    static equals(left?: AxisAlignedBoundingBox, right?: AxisAlignedBoundingBox): boolean {
        return left === right || (defined(left) && defined(right) && Cartesian3.equals((left as AxisAlignedBoundingBox).center, (right as AxisAlignedBoundingBox).center) && Cartesian3.equals((left as AxisAlignedBoundingBox).minimum, (right as AxisAlignedBoundingBox).minimum) && Cartesian3.equals((left as AxisAlignedBoundingBox).maximum, (right as AxisAlignedBoundingBox).maximum));
    }
     ...
     */
    static intersectPlane(box: AxisAlignedBoundingBox, plane: CesiumPlane): Intersect {
