...
export default class CesiumQuaternion extends Quaternion {
    /**
    ...
    static fromHeadingPitchRoll(headingPitchRoll: HeadingPitchRoll, result?: CesiumQuaternion): CesiumQuaternion {
        scratchRollQuaternion = CesiumQuaternion.fromAxisAngle(Cartesian3.UNIT_X, headingPitchRoll.roll, scratchHPRQuaternion);
        scratchPitchQuaternion = CesiumQuaternion.fromAxisAngle(Cartesian3.UNIT_Y, -headingPitchRoll.pitch, result);
        result = CesiumQuaternion.multiply(scratchPitchQuaternion, scratchRollQuaternion, scratchPitchQuaternion);
        scratchHeadingQuaternion = CesiumQuaternion.fromAxisAngle(Cartesian3.UNIT_Z, -headingPitchRoll.heading, scratchHPRQuaternion);
