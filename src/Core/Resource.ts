...
class Resource {
     ...
     */
    getDerivedResource(options: { url?: string; queryParameters?: any; templateValues?: any; headers?: any; retryCallback?: any; retryAttempts?: number; request?: any; proxy?: any; preserveQueryParameters?: boolean }): Resource {
        ...
        if (defined(options.url)) {
            ...
            const preserveQueryParameters = defaultValue(options.preserveQueryParameters, false) as boolean;
    ...
    retryOnError(error: any): any {
        ...
        const that = this;
        return Promise.resolve(retryCallback(this, error)).then(function (result: any) {
            ++that._retryCount;
    ...
    _makeRequest(options: any) {
        ...
        request.requestFunction = function () {
            ...
            const xhr = Resource._Implementations.loadWithXhr(resource.url, responseType, method, data, headers, deferred, overrideMimeType);
        ...
        const promise = RequestScheduler.request(request) as Promise<unknown>;
        if (!defined(promise)) {
            return;
        }
...
function fetchImage(options?: any) {
    ...
    return promise.catch(function (e: any) {
...
Resource._Implementations.createImage = function (request: any, crossOrigin: any, deferred: any, flipY: any, skipColorSpaceConversion: any, preferImageBitmap: any) {
...
Resource._Implementations.loadWithXhr = function (url: any, responseType: any, method: any, data: any, headers: any, deferred: any, overrideMimeType: any) {
    ...
    xhr.onload = function () {
        ...
        } else if ((browserResponseType === '' || browserResponseType === 'document') && defined(xhr.responseXML) && (xhr as any).responseXML.hasChildNodes()) {
