 ...
 */
export default class TileImagery {
    readyImagery: any;
    loadingImagery?: Imagery;
    textureCoordinateRectangle: Cartesian4;
    textureTranslationAndScale: any;
     ...
     */
    processStateMachine(tile: any, frameState: FrameState, skipLoading: boolean): boolean {
        ...
        let ancestor = loadingImagery.parent as Imagery;
        ...
        while (defined(ancestor) && (ancestor.state !== ImageryState.READY || (!this.useWebMercatorT && !defined(ancestor.texture)))) {
            ...
            ancestor = ancestor.parent as Imagery;
        }
        ...
        if (loadingImagery.state === ImageryState.FAILED || loadingImagery.state === ImageryState.INVALID) {
            ...
            if (defined(closestAncestorThatNeedsLoading)) {
                ...
                // we don't do it here.
                (closestAncestorThatNeedsLoading as Imagery).processStateMachine(frameState, !this.useWebMercatorT, skipLoading);
