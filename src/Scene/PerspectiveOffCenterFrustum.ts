...
function update(frustum: PerspectiveOffCenterFrustum) {
    ...
    if (t !== frustum._top || b !== frustum._bottom || l !== frustum._left || r !== frustum._right || n !== frustum._near || f !== frustum._far) {
        ...
        frustum._near = n;
        frustum._far = f;
        frustum._perspectiveMatrix = CesiumMatrix4.computePerspectiveOffCenter(l, r, b, t, n, f, frustum._perspectiveMatrix);
        frustum._infinitePerspective = CesiumMatrix4.computeInfinitePerspectiveOffCenter(l, r, b, t, n, frustum._infinitePerspective);
    }
}
